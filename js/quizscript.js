...
function showingresultBox(){
    ...
    if (userScore > 17) {
        var scoreTag =  "<span>Congrats! You got "+ userScore +" out of "+ ques.length*2 +"</span>";
        scoreTxt.innerHTML = scoreTag;
    }

    else if (17 > userScore > 13) {
        var scoreTag =  "<span>You got "+ userScore +" out of "+ ques.length*2 +"</span>";
        scoreTxt.innerHTML = scoreTag;
    }

    else{
        var scoreTag =  "<span>Badly, You got "+ userScore +" out of "+ ques.length*2 +"</span>";
        scoreTxt.innerHTML = scoreTag;
    }

    //calculating the marks and time
    var marksTag = "<span>Marks: " + userScore + "</span>";
...
//show ing the question number in the footer
